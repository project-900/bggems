...
exports.GetSalesPersonsUseCase = void 0;
class GetSalesPersonsUseCase {
    ...
    execute({ Status }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const GetSalesPersons = yield this.SalesPersonRepository.getSalesPersons({ Status });
...
exports.GetSalesPersonsUseCase = GetSalesPersonsUseCase;
